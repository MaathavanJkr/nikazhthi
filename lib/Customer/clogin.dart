...
import 'csignup.dart';
import 'package:Nikazhthi/Test/test.dart';
const appName = 'Login';
...
class CustLoginPage extends StatefulWidget {
  @override
  CustLoginPageState createState() => CustLoginPageState();
}

class CustLoginPageState extends State<CustLoginPage> {
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CustSignupPage()),
                        );
                      },
                      elevation: 0,
                      padding: EdgeInsets.all(15.0),
